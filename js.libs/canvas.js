        ...
        document.getElementById('zoomText').textContent = toFixed(((canvas.getZoom()/2 )*100),2) + "% ("+toFixed(canvas.getZoom(),2)+"°)";
        ...
        function zoom(opt) {
            ...
            if(zoom>0 && zoom<2){
                ...
                document.getElementById('zoomText').textContent = toFixed(((zoom/2) *100),2) + "% ("+toFixed(zoom,2)+"°)";
            }
            if(typeof opt != 'undefined'){
